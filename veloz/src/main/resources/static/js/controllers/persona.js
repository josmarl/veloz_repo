...
app.controller('personaController', ['$scope', '$rootScope', '$http', '$location', '$routeParams', function($scope, $rootScope, $http, $location, $routeParams) {

    $scope.headingTitle = "Configuración de Personas";
      $scope.personas = [];
    $scope.persona = {};
    $scope.idPersona = $routeParams.id;
